...
using Acme.BookStore.Report.Blazor.Client;
using Acme.BookStore.Report.Blazor.Client.Menus;
using Acme.BookStore.Report.Blazor.Client.Reports;
using Acme.BookStore.Report.Blazor.Components;
using Acme.BookStore.Report.Blazor.Controllers;
...
public class ReportBlazorModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "31e39972-110e-454f-a42b-ff8e6bf863cd");
            });
        }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        //context.Services.AddScoped<DevExpress.XtraReports.Services.IReportProviderAsync, DemoReportSourceWasm>();
        ...
        context.Services.AddScoped<ReportStorageWebExtension, ReportStorage>();
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/Acme.BookStore.Report.Blazor.Client.styles.css", true));
                }
            );
        });
    }
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new ReportMenuContributor(context.Services.GetConfiguration()));
        });
    }
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        Configure<AbpRouterOptions>(options =>
        {
            ...
            options.AdditionalAssemblies.Add(typeof(ReportBlazorClientModule).Assembly);
        });
    }
